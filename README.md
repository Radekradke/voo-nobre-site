...
![PHP](https://img.shields.io/badge/PHP-Formulário-777BB4?style=for-the-badge&logo=php&logoColor=fff)
...
```mermaid
flowchart LR
    A["Visitante acessa o site"] --> B["Conhece a proposta da Voo Nobre"]
    B --> C["Explora serviços e diferenciais"]
    C --> D["Lê informações, depoimentos e FAQ"]
    D --> E{"Quer avançar?"}
    E -- "Sim" --> F["Solicita orçamento ou envia contato"]
    E -- "Ainda avaliando" --> G["Continua navegando pela página"]
    F --> H["Marca recebe a solicitação"]
```
